...
const config = {
  ...
  trading: {
    ...
    preFundingWindowMinutes:
      parseInt(process.env.PRE_FUNDING_WINDOW_MINUTES) || 5, // 5min
    ...
    orderCooldownMinutes: parseInt(process.env.ORDER_COOLDOWN_MINUTES) || 5, // 120 minutes (2 hours) cooldown between trades
    ...
    // Phase 5: Exit Logic
    maxWaitForFundingSeconds:
      parseInt(process.env.MAX_WAIT_FOR_FUNDING_SECONDS) || 300, // 5 minutes wait for funding
  },
